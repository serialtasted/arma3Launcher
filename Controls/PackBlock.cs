...
namespace arma3Launcher.Controls
{
    public partial class PackBlock : UserControl
    {
        ...
        public PackBlock(MainForm mainForm, string packTitle, string packID, string packDescription, string packAddons, FlowLayoutPanel packsPanel, bool isOptionalAllowed)
        {
            InitializeComponent();
